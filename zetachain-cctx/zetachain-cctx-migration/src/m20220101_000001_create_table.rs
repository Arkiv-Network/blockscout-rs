        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(CrossChainTx::ProtocolContractVersion).string().not_null())
                    .to_owned(),
            )
            .await?;
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(CctxStatus::CrossChainTxId).integer().not_null())
                    ...
                    .col(ColumnDef::new(CctxStatus::LastUpdateTimestamp).string().not_null())
                    .col(ColumnDef::new(CctxStatus::IsAbortRefunded).boolean().not_null())
                    .col(ColumnDef::new(CctxStatus::CreatedTimestamp).string().not_null())
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(InboundParams::CrossChainTxId).integer().not_null())
                    .col(ColumnDef::new(InboundParams::Sender).string().not_null())
                    .col(ColumnDef::new(InboundParams::SenderChainId).string().not_null())
                    ...
                    .col(ColumnDef::new(InboundParams::ObservedHash).string().not_null())
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(OutboundParams::CrossChainTxId).integer().not_null())
                    .col(ColumnDef::new(OutboundParams::Receiver).string().not_null())
                    .col(ColumnDef::new(OutboundParams::ReceiverChainId).string().not_null())
                    ...
                    .col(ColumnDef::new(OutboundParams::GasPriorityFee).string().null())
                    .col(ColumnDef::new(OutboundParams::Hash).string().null())
                    .col(ColumnDef::new(OutboundParams::BallotIndex).string().null())
                    .col(ColumnDef::new(OutboundParams::ObservedExternalHeight).string().not_null())
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(RevertOptions::CrossChainTxId).integer().not_null())
                    .col(ColumnDef::new(RevertOptions::RevertAddress).string().null())
                    .col(ColumnDef::new(RevertOptions::CallOnRevert).boolean().not_null())
                    .col(ColumnDef::new(RevertOptions::AbortAddress).string().null())
                    .col(ColumnDef::new(RevertOptions::RevertMessage).text().null())
                    .col(ColumnDef::new(RevertOptions::RevertGasLimit).string().not_null())
                    .foreign_key(
                        ForeignKey::create()
